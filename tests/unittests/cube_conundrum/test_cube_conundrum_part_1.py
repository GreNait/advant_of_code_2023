import pathlib
from src.cube_conundrum.cube_conundrum import CubeConundrum
...
def test_load_list_of_games_by_path():
    path_to_list = pathlib.Path("tests/unittests/cube_conundrum/list_of_test_games.txt")
