...
class TrebuchetLetters(Trebuchet):
    ...
    def _first_digit(self, value: str) -> str:
        ...
        number_index = self.__number_index(
            value=value, number=super()._first_digit(value), find=value.find
        )
    ...
    def _last_digit(self, value: str) -> str:
        ...
        number_index = self.__number_index(
            value=value, number=super()._last_digit(value), find=value.rfind
        )
        self.__check_for_no_indices(letter_number_indices, number_index)
        return self.__search_last_number(letter_number_indices, number_index)

    def __search_first_number(
        self, letter_number_indices: list[dict], number_index: dict
    ) -> str:
